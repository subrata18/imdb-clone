  ...
  return (
    <nav className="flex justify-between bg-gray-900 h-14 md:justify-around">
      ...
      <div className="justify-around hidden w-11/12 mx-3 align-middle md:flex">
        ...
        <button className="rounded-md w-7 h-7 justify-items-end">
          <img className="inline object-cover mx-1 my-3 mr-3 cursor-pointer" src="https://www.pngitem.com/pimgs/m/634-6342297_menu-bar-icon-white-clipart-png-download-3.png" alt="menu-bar" />
        </button>
