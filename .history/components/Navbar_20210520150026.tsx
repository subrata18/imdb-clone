  ...
  return (
    <nav className="flex justify-between bg-gray-900 h-14 md:justify-around">
      ...
      <div className="justify-around hidden w-11/12 mx-3 align-middle md:flex">
        ...
        <Dropdown>
          <button className="w-8 h-8 justify-items-end">
            <img className="inline object-cover w-8 h-8 mx-1 my-3 mr-3 cursor-pointer justify-right" src="https://www.pngitem.com/pimgs/m/634-6342297_menu-bar-icon-white-clipart-png-download-3.png" alt="Profile image" />
          </button>
        </Dropdown>
      </div>
