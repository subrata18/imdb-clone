  ...
  return (
    <nav className="flex justify-between bg-gray-900 h-14 md:justify-around">
      ...
      <div className="justify-around hidden w-11/12 mx-3 align-middle md:flex">
        ...
        <Link href="">
          <a className="inline-block px-2 py-1 text-sm font-semibold text-white bg-blue-500 rounded" href="#">Log In</a>
        </Link>

        <button className="w-7 h-7 justify-items-end">
          <img className="inline object-cover mx-1 my-3 mr-3 rounded-md cursor-pointer" src="https://www.pngitem.com/pimgs/m/634-6342297_menu-bar-icon-white-clipart-png-download-3.png" alt="menu-bar" />
        </button>
