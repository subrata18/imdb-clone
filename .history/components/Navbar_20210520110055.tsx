  ...
  return (
    <nav className="flex justify-between bg-gray-900 h-14 md:justify-around">
      ...
      <div className="justify-around hidden w-11/12 mx-3 align-middle md:flex">
        ...
        <Link href="/Profile">
          <img className="inline object-cover w-10 h-10 mr-2 rounded-full" src="https://images.pexels.com/photos/2589653/pexels-photo-2589653.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="Profile image" />
