  ...
  return (
    <nav className="flex justify-between bg-gray-900 h-14 md:justify-around">
      ...
      <div className="justify-around hidden w-11/12 mx-3 align-middle md:flex">
        ...
        <Link href="/Profile">
          <img className="inline object-cover w-8 h-8 mx-1 my-3 mr-3 rounded-full" src="https://uxwing.com/wp-content/themes/uxwing/download/12-people-gesture/user-profile.png" alt="Profile image" />
