  ...
  return (
    <nav className="flex justify-between bg-gray-900 h-14 md:justify-around">
      ...
      <div className="justify-around hidden w-11/12 mx-3 align-middle md:flex">
        ...
        <Dropdown>
          <button>
            <img className="inline object-cover w-8 h-8 mx-1 my-3 mr-3 rounded-full cursor-pointer" src="https://www.pngitem.com/pimgs/m/634-6342297_menu-bar-icon-white-clipart-png-download-3.png" alt="Profile image" />
        </Link>
          </button>
        </Dropdown>
      </div>
